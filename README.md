...
- After humidifer displays 1 bar, start to fill the humidifer with water. The sensor will use default values to show you the level. Fill the water until 5 bars begin flashing. If the level does not change from 1 bar at all, and only at the end directly displays 5 flashing bars, then you probably have a problem with the circuit.
